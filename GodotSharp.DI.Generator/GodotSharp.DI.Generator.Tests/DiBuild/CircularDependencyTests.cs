...
";
    ...
    [Fact]
    public void Build_SingletonDependsOnTransient_ReportsDiagnostic()
    {
        // Arrange
        var source =
            @"
...
";
        ...
        Assert.Contains(
            result.Diagnostics,
            d => d.Id == "GDI_D030" // SingletonCannotDependOnTransient
        );
    }

    [Fact]
    public void Build_TransientDependsOnSingleton_IsValid()
    {
        // Arrange
        var source =
            @"
