...
";
    ...
    [Fact]
    public void Process_UserMemberInNodeUser_ReturnsUserMemberInfo()
    {
        // Arrange
        var source =
            @"
...
namespace Test
{
    ...
    [User]
    public partial class ParentUser : Node
    {
        private ChildUser _child = new();
    }
}
";
    ...
    [Fact]
    public void Process_UserMemberIsNode_ReportsDiagnostic()
    {
        // Arrange
        var source =
            @"
...
{
    [User]
    public partial class ChildUser : Node { }
...
";
        ...
        Assert.Contains(
            result.Diagnostics,
            d => d.Id == "GDI_M070" // UserMemberCannotBeNode
        );
    }

    [Fact]
    public void Process_NonNodeUserContainsUserMember_ReportsDiagnostic()
    {
        // Arrange
        var source =
            @"
...
";
        ...
        Assert.Contains(
            result.Diagnostics,
            d => d.Id == "GDI_M071" // NonNodeUserCannotContainUserMember
        );
    }

    [Fact]
    public void Process_UserMemberWithoutInitializer_ReportsDiagnostic()
    {
        // Arrange
        var source =
            @"
...
";
        ...
        Assert.Contains(
            result.Diagnostics,
            d => d.Id == "GDI_M072" // UserMemberMustBeInitialized
        );
    }
