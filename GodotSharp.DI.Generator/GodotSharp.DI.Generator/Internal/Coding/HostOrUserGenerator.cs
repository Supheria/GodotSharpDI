...
//     }
//
//     private static string GenerateHostSource(TypeNode hostInfo)
//     {
...
//         f.AppendLine();
//
//         f.AppendLine($"partial class {FormatClassName(hostInfo.TypeInfo.Symbol)}");
//         f.BeginBlock();
//         {
//             // AttachHostServices
//             f.AppendLine(
...
//     }
//
//     private static string GenerateUserSource(TypeNode userInfo)
//     {
//         var f = new CodeFormatter();
//
//         SourceGenHelper.AppendFileHeader(f);
